    ...
    <AnimatePresence>
      <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100vh', zIndex: 9999, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <motion.div 
          ...
          style={{ position: 'relative', width: '90%', maxWidth: '1000px', background: 'var(--white)', borderRadius: '16px', overflow: 'hidden', display: 'flex', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.5)', maxHeight: '90vh' }}
        >
          {/* Close Button */}
          <button onClick={onClose} style={{ position: 'absolute', top: '1.5rem', right: '1.5rem', background: 'var(--bg-color)', border: 'none', width: '40px', height: '40px', borderRadius: '50%', fontSize: '1.5rem', cursor: 'pointer', zIndex: 10 }}>×</button>

          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', width: '100%' }}>
            {/* Left Info Side */}
            <div style={{ background: '#FDF9F1', padding: '4rem 3rem', display: 'flex', flexDirection: 'column' }}>
              <h2 style={{ fontSize: '2.5rem', marginBottom: '1rem', color: '#3E2723', fontFamily: 'Playfair Display, serif', lineHeight: 1.1 }}>Let's Start a<br/>Conversation</h2>
              <div style={{ width: '50px', height: '2px', background: 'var(--gold-dark)', marginBottom: '3rem' }}></div>
              
              <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                <div style={{ display: 'flex', gap: '1rem' }}>
                  <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'rgba(197, 144, 79, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--gold-dark)' }}>📍</div>
                  <div>
                    ...
                    <p style={{ fontWeight: 500, color: '#3E2723' }}>123 Builder Square, Dadar, Mumbai</p>
                  </div>
                </div>
                <div style={{ display: 'flex', gap: '1rem' }}>
                  <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'rgba(197, 144, 79, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--gold-dark)' }}>📞</div>
                  <div>
                    ...
                    <p style={{ fontWeight: 500, color: '#3E2723' }}>+91 98765 43210</p>
                  </div>
                </div>
                <div style={{ display: 'flex', gap: '1rem' }}>
                  <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'rgba(197, 144, 79, 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--gold-dark)' }}>✉️</div>
                  <div>
                    ...
                    <p style={{ fontWeight: 500, color: '#3E2723' }}>info@svbuilders.com</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Right Form Side */}
            <div style={{ padding: '4rem 3rem', overflowY: 'auto' }}>
              ...
              <form onSubmit={handleFormSubmit}>
                ...
                <div className="form-group">
                  ...
                  <select name="projectId" className="form-input" value={formData.projectId} onChange={handleInputChange} style={{ appearance: 'none', background: '#F8F9FA' }}>
